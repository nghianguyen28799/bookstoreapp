...
const Home = ({ navigation }) => {
            ...
            paddingHorizontal: SIZES.padding, alignItems: 'center' }}>
                <View style={{ flex: 1 }}>
                    <View style={{ marginRight: SIZES.padding }}>
                        ...
                        <Text style={{  color: COLORS.white, fontSize: 16}}>{profile.name}</Text>
                    </View>
                </View>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <Text style={{ marginLeft: SIZES.base, color: COLORS.white,  fontSize: 16}}>{profile.point} point</Text>
                    </View>
                </TouchableOpacity>
            </View>
        )
            ...
            <View style={{ flex: 1, justifyContent: 'center', padding: SIZES.padding}}>
                <View style={{ flexDirection: 'row', height: 70, backgroundColor: COLORS.secondary, borderRadius: SIZES.radius }}>
                    ...
                    <View style={{ flex: 1,flexDirection: 'row', alignItems: 'center', justifyContent: 'center',  }}>
                        ...
                        />
                        <Text style={{ marginLeft: SIZES.base, fontSize: 13, color: COLORS.white }}>Claim</Text>
                    </View>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        />
                        <Text style={{ marginLeft: SIZES.base, fontSize: 13, color: COLORS.white }}>Get Point</Text>
                    </View>
                    </TouchableOpacity>
                    {/* Divder  */}
                    <LineDiver />
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        />
                        <Text style={{ marginLeft: SIZES.base, fontSize: 13, color: COLORS.white }}>My Card</Text>
                    </View>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            return (
                ...
                >
                    ...
                    <View style={{ marginTop: SIZES.radius, flexDirection: 'row', alignItems: 'center'}}>
                        ...
                        <Text style={{ marginLeft: 5, color: COLORS.lightGray }}>
                            {item.completion}
                        </Text>
                    </View>
                </TouchableOpacity>
        ...
        return (   
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: SIZES.padding }} >
                    <Text style={{ flex: 1, color: COLORS.white, fontSize: 16 }}>My Book</Text>
            
                    <TouchableOpacity
                        onPress={() => console.log('See More')}
                    >
                        <Text style={{ color: COLORS.lightGray, textTransform: 'uppercase', fontSize: 13 }}>
                            see more
                        </Text>
                    </TouchableOpacity>
                </View>
    ...
    function renderCategoryData() {
        ...
        let selectedCategoryBooks = categories.filter(data => data.id == selectCategory)
            ...
            return(
                <View style={{ marginVertical: SIZES.base }}>
                    ...
                    >
                        ...
                        />
                        <View style={{ flex: 1, marginLeft: SIZES.radius, marginRight: SIZES.radius }}>
                            {/* Book name & Author */}
                            <View>
                                <Text style={{ color: COLORS.white, fontSize: 16, fontWeight: '700' }}>{item.bookName}</Text>
                           ...
                           <View style={{ flexDirection: 'row', marginTop: SIZES.radius}}>
                                ...
                                />
                                <Text style={{ color: COLORS.lightGray, paddingLeft: SIZES.radius, fontSize: 13 }}>{item.pageNo}</Text>
                           </View>
                           ...
                           <View style={{ flexDirection: 'row', paddingTop: SIZES.base }}>
                                {
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center',
                                        padding: SIZES.base, marginRight: SIZES.base, backgroundColor: COLORS.darkGreen,
                                        height: 40, borderRadius: SIZES.radius
                                    }}>
                                        <Text style={{ fontSize: 12, color: COLORS.lightGreen }}>
                                            Adventure
                                        </Text>
                                    </View>
                                }
                                {
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center',
                                        padding: SIZES.base, marginRight: SIZES.base, backgroundColor: COLORS.darkRed,
                                        height: 40, borderRadius: SIZES.radius
                                    }}>
                                        <Text style={{ fontSize: 12, color: COLORS.lightRed}}>
                                            Romance
                                        </Text>
                                    </View>
                                }
                                {
                                    ...
                                    <View style={{ justifyContent: 'center', alignItems: 'center',
                                        padding: SIZES.base, marginRight: SIZES.base, backgroundColor: COLORS.darkBlue,
                                        height: 40, borderRadius: SIZES.radius
                                    }}>
